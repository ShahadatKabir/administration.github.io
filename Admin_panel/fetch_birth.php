...
<!doctype html>
    <html lang="en">
      ...
      <body>
      <!--Page Direction-->
      <h6 class="pl-2 p"><a href="./index.php" class="a1">Admin Index</a> > <a class="a1" href="./service.php">Services Request</a> > Birth Certidficate Request</h6>
    ...
    <div class="pl-1">
        ...
        <?php
            ...
            //Executing sql query.
            $sql = "SELECT * FROM `bc_applicant_info`";
            ...
            <?php
                ...
                if($total_rows > 0)
                {
                    while($row = mysqli_fetch_assoc($result))
                    {
                        ...
                        <td>'.$pdd.'</td>
                        <td class="td1">
                        <a class="btn btn-sm btn-primary glyphicon glyphicon-pencil text-light" href="birth_edit.php?edit_id='.$name.'"> </a>
                    </td>
                    <td>
                        <a class="text-light btn btn-sm btn-danger glyphicon glyphicon-trash" href="birth_delete.php?del_id='.$name.'" onclick="return delete_permission()"> </a>
                    </td>';
